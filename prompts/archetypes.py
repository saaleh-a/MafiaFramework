...
ARCHETYPES: dict[str, dict] = {
    ...
    "Contrarian": {
        "strategy_modifier": (
            ...
            "messages, your ACTION must do EXACTLY ONE of the following:\n"
            "  A. Name a DIFFERENT specific player as your lean, with a concrete "
            "behavioural reason. Your statement must end with that other player as "
            "your named target — not the consensus target.\n"
            "  B. Make a direct counter-argument that identifies a specific flaw "
            "in the current case against the consensus target. You may NOT name "
            "the consensus target as your lean anywhere in your ACTION.\n"
            "BANNED: joining the consensus target while adding commentary about the "
            "pile. 'I guess I'll go with X but the pile feels fast' FAILS — it joins "
            "the vote AND counts as meta-commentary. Observing that the pile exists "
            "or that it is moving fast is NOT a counter-argument. If you have no "
            "better alternative target, choose Option B and identify a specific flaw "
            "in the evidence — do not join the consensus.\n\n"
