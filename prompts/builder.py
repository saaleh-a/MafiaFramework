...
DISCUSSION_RULES: str = (
    ...
    "Before stating any suspicion or lean, you MUST reproduce the EXACT WORDS "
    "from another player's statement — use quotation marks around the quoted text — "
    "then explain why those specific words are or are not credible.\n"
    "BANNED: 'I'm with X on this', 'Alice made a good point about Hank', "
    "'what Alice said lines up for me'. These are agreements, not engagements.\n"
    "REQUIRED: 'Alice said \"Hank was the safest first test\" — that framing "
    "assumes Hank is safe by default, which is backwards.' Direct quote + "
    "specific reason why those words hold or don't. No quote = no claim.\n\n"
    "OWN READ FIRST:\n"
    ...
    *,
    ...
    return "\n\n".join([
        ...
        *framework_sections,
        ...
        # Lifeline Protocol: graduated identity reveal with red-check awareness
        (
            "IDENTITY REVEAL PROTOCOL (Lifeline Protocol — Graduated Response):\n"
            ...
            "When the system tells you to reveal (any LIFELINE PROTOCOL level), follow "
...
def build_doctor_prompt(
    ...
    *,
    ...
    return "\n\n".join([
        ...
        CONVERSATIONAL_RULE,
        *framework_sections,
        # Lifeline Protocol for Doctor
        (
            "IDENTITY REVEAL PROTOCOL (Lifeline Protocol):\n"
